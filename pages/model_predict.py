...
| 6   | Transcription factor        | [Description](https://en.wikipedia.org/wiki/Transcription_factor#:~:text=In%20molecular%20biology%2C%20a%20transcription,to%20a%20specific%20DNA%20sequence.)""")
    ...
    st.write(""" > Type or copy paste the DNA string into the input section below. Or you can upload a text file that contains your DNA string. You can get a sample DNA string [here](https://raw.githubusercontent.com/CyrilleMesue/dna-seq-classifier/main/datasets/sample.txt)""")
